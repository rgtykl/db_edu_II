...
ALTER TABLE student12.tb_books_list_for_orders ADD CONSTRAINT fk_tb_books_list_for_orders_book_id FOREIGN KEY (book_id) REFERENCES student12.tb_books(id);
